...
const AIDemo = () => {
  ...
  return (
    <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-[#66B539] transition-all duration-300">
      <div className="flex items-center mb-6">
        <Brain className="w-6 h-6 text-[#66B539] mr-3" />
      ...
      <div className="space-y-4">
        <div>
          ...
          <input 
            ...
            className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-[#66B539] focus:outline-none transition-colors duration-200"
        ...
        <button 
          ...
          className="w-full bg-[#66B539] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#66B539]/90 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 flex items-center justify-center space-x-2"
        >
          {isProcessing ? (
            <>
        ...
        {aiResponse && (
          <div className="mt-6 space-y-3">
            <h4 className="text-gray-900 font-semibold flex items-center">
              <CheckCircle className="w-4 h-4 text-[#66B539] mr-2" />
                ...
                <div className="flex items-center space-x-4 text-sm">
                  ...
                  <div className="flex items-center space-x-1">
                    {item.tags.map((tag, tagIndex) => (
                      <span key={tagIndex} className="bg-[#66B539]/10 text-[#66B539] px-2 py-1 rounded text-xs">
                        #{tag}
                      </span>
                    ))}
                  </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-20 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#66B539]/5 via-transparent to-[#66B539]/5"></div>
        <div className="absolute top-20 left-20 w-72 h-72 bg-[#66B539]/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-[#66B539]/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="text-center">
            <div className="inline-flex items-center bg-[#66B539]/10 border border-[#66B539]/30 rounded-full px-6 py-2 mb-8">
              <Zap className="w-4 h-4 text-[#66B539] mr-2" />
              <span className="text-[#66B539] font-medium text-sm">Powered by Advanced AI</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              AI That Manages
              <span className="block text-[#66B539]">
                Your Tasks
              </span>
                  ...
                  <div 
                    ...
                    className={`p-6 rounded-2xl border transition-all duration-500 transform hover:scale-105 ${
                      currentFeature === index 
                        ? 'bg-[#66B539]/10 border-[#66B539] shadow-lg shadow-[#66B539]/20' 
                        : 'bg-gray-50 border-gray-200 hover:border-[#66B539]/50'
                    }`}
                  >
                    <Icon className={`w-8 h-8 mb-4 mx-auto transition-colors duration-300 ${
                      currentFeature === index ? 'text-[#66B539]' : 'text-gray-400'
                    }`} />
      ...
      {/* AI Demo Section */}
      <section id="demo" className="py-20 bg-gradient-to-r from-[#66B539]/5 to-transparent">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8">
              <div className="text-4xl md:text-5xl font-bold text-[#66B539] mb-2">10K+</div>
              <div className="text-gray-600">AI-Powered Teams</div>
            </div>
            <div className="p-8">
              <div className="text-4xl md:text-5xl font-bold text-[#66B539] mb-2">50M+</div>
              <div className="text-gray-600">Tasks Auto-Organized</div>
            </div>
            <div className="p-8">
              <div className="text-4xl md:text-5xl font-bold text-[#66B539] mb-2">300%</div>
      ...
      {/* AI Features Detail */}
      <section id="features" className="py-20 bg-gradient-to-br from-[#66B539]/5 to-[#66B539]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-[#66B539]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Brain className="w-6 h-6 text-[#66B539]" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-[#66B539]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Target className="w-6 h-6 text-[#66B539]" />
                </div>
                <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-[#66B539]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Calendar className="w-6 h-6 text-[#66B539]" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-[#66B539]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Tag className="w-6 h-6 text-[#66B539]" />
                </div>
                <div>
